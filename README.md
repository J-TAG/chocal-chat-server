...
1. `accepted` : Means client is successfuly connected to server and now can send messages.
...
I have planned to create several type of clients to Chocal Server. But in the meantime I'm working on web client. Although by the roadmap we should have a desktop client that can be run on Mac, Linux and Windows and also an Android app.
